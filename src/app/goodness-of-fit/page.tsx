...
export default function Page() {
  return (
    <ArticleWrapper>
      ...
      <BlockMath math="\text{Pr(} \leq \text{1 heads } \text{or} \leq \text{1 tails} \text{)} = 2 \left( \left(\frac{1}{2}\right)^{10} + 10 \left( \frac{1}{2} \right)^{1} \left( \frac{1}{2} \right)^{9} \right) = \frac{11}{512} \approx 2.1\%" />
      <p>
